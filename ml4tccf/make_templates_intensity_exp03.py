"""Makes CNN templates for Intensity Experiment 3.

Same as Experiment 2 but with sigmoid activation for output.
"""
...
OUTPUT_DIR_NAME = (
    ...
    'intensity_experiment03/templates'
)
...
DEFAULT_OPTION_DICT = {
    ...
    tcnn_architecture.PREDICT_SIGMOID_INTENSITY: True
}
