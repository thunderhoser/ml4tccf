...
from ml4tccf.scripts import training_args_intensity as training_args

INPUT_ARG_PARSER = argparse.ArgumentParser()
INPUT_ARG_PARSER = training_args.add_input_args(parser_object=INPUT_ARG_PARSER)


def _run(template_file_name, center_fixing_model_file_name, output_dir_name,
         ...
         satellite_dir_name_for_training, ebtrk_file_name_for_training,
         training_years,
         satellite_dir_name_for_validation, ebtrk_file_name_for_validation,
         validation_years,
         num_epochs,
    ...
    training_option_dict = {
        ...
        nn_utils.TRAIN_WITH_SHUFFLED_DATA_KEY: True
    }
...
if __name__ == '__main__':
    ...
    _run(
        ...
        center_fixing_model_file_name=getattr(
            INPUT_ARG_OBJECT, training_args.CENTER_FIXING_MODEL_FILE_ARG_NAME
        ),
        ...
        ebtrk_file_name_for_training=getattr(
            INPUT_ARG_OBJECT, training_args.EBTRK_FILE_FOR_TRAINING_ARG_NAME
        ),
        ...
        ebtrk_file_name_for_validation=getattr(
            INPUT_ARG_OBJECT, training_args.EBTRK_FILE_FOR_VALIDATION_ARG_NAME
        ),
