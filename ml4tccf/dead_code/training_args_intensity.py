...
# TODO(thunderhoser): Allow for multiple models, i.e., an ensemble.
...
EBTRK_FILE_FOR_TRAINING_ARG_NAME = 'ebtrk_file_name_for_training'
...
EBTRK_FILE_FOR_VALIDATION_ARG_NAME = 'ebtrk_file_name_for_validation'
...
TEMPLATE_FILE_HELP_STRING = (
    ...
    'by `neural_net_utils.read_model`.'
)
CENTER_FIXING_MODEL_FILE_HELP_STRING = (
    'Path to trained neural net that does center-fixing.  This will be read by '
...
EBTRK_FILE_FOR_TRAINING_HELP_STRING = (
    'Path to EBTRK (extended best-track) file for training data.  Will be read '
    'by `extended_best_track_io.read_file`.'
)
...
EBTRK_FILE_FOR_VALIDATION_HELP_STRING = (
    'Path to EBTRK (extended best-track) file for validation data.  Will be '
...
def add_input_args(parser_object):
    ...
    parser_object.add_argument(
        '--' + CENTER_FIXING_MODEL_FILE_ARG_NAME, type=str, required=True,
        help=CENTER_FIXING_MODEL_FILE_HELP_STRING
    )
    parser_object.add_argument(
    ...
    parser_object.add_argument(
        '--' + EBTRK_FILE_FOR_TRAINING_ARG_NAME, type=str, required=True,
        help=EBTRK_FILE_FOR_TRAINING_HELP_STRING
    )
    parser_object.add_argument(
    ...
    parser_object.add_argument(
        '--' + EBTRK_FILE_FOR_VALIDATION_ARG_NAME, type=str, required=True,
        help=EBTRK_FILE_FOR_VALIDATION_HELP_STRING
    )
    parser_object.add_argument(
