"""Makes templates for Paper Experiment 3b (Exp 3 with simple optimizer)."""
...
OUTPUT_DIR_NAME = (
    ...
    'paper_experiment03b_domain_video_atcf/templates'
)
...
INCLUDE_ATCF_FLAGS_AXIS2 = numpy.array([0, 1], dtype=bool)
LAG_TIME_COUNTS_AXIS3 = numpy.array([1, 3, 5, 7, 9, 11, 13], dtype=int)
...
def _run():
    ...
    for i in range(len(GRID_ROW_COUNTS_AXIS1)):
        for j in range(len(INCLUDE_ATCF_FLAGS_AXIS2)):
            for k in range(len(LAG_TIME_COUNTS_AXIS3)):
                ...
                output_file_name = (
                    ...
                    int(INCLUDE_ATCF_FLAGS_AXIS2[j]),
