"""Makes templates for Experiment 9 -- tweak input channels and num filters."""
...
OUTPUT_DIR_NAME = (
    ...
    'experiment09_channels_and_filters/templates'
)

NUM_SCALAR_PREDICTORS = 12
NUM_CONV_BLOCKS = 7
ENSEMBLE_SIZE = 50
NUM_DENSE_LAYERS = 4
...
FIRST_LAYER_FILTER_COUNTS = numpy.array([8, 12, 16, 20, 24, 28, 32], dtype=int)
...
def _run():
    ...
    for i in range(len(FIRST_LAYER_FILTER_COUNTS)):
        ...
        output_file_name = (
            '{0:s}/num-first-layer-filters={1:02d}/model.h5'
        ).format(
            OUTPUT_DIR_NAME, FIRST_LAYER_FILTER_COUNTS[i]
        )
        ...
        option_dict[cnn_architecture.LOSS_FUNCTION_KEY] = LOSS_FUNCTION_STRING
        option_dict[cnn_architecture.OPTIMIZER_FUNCTION_KEY] = OPTIMIZER_STRING
