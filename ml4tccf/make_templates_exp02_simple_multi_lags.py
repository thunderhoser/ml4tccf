"""Makes templates for Experiment 2 (batches and channels)."""
...
OUTPUT_DIR_NAME = (
    ...
    'experiment02_batches_and_channels/simple_multiple_lags/templates'
)
...
DEFAULT_OPTION_DICT = {
    cnn_architecture.INPUT_DIMENSIONS_LOW_RES_KEY:
        numpy.array([600, 600, 11], dtype=int),
    ...
    cnn_architecture.DENSE_DROPOUT_RATES_KEY: numpy.array([0.3, 0.3, 0.3, 0]),
...
FIRST_LAYER_CHANNEL_COUNTS = numpy.array([4, 8, 12, 16, 20], dtype=int)
BATCHES_PER_UPDATE_COUNTS = numpy.array([2, 4, 6, 8, 10], dtype=int)
