...
--input_prediction_file_pattern="${model_dir_name}/isotonic_regression/testing_by_storm_type/storm-type=non_tropical/testing_by_basin/${basin_id_string}/predictions*.nc" \
...
--output_file_name="${model_dir_name}/isotonic_regression/testing_by_storm_type/storm-type=non_tropical/testing_by_basin/${basin_id_string}/evaluation.nc"
