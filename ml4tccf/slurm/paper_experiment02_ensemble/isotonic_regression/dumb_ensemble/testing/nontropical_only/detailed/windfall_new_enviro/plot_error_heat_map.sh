...
python3 -u "${CODE_DIR_NAME}/plot_error_heat_map.py" \
...
--plot_orig_errors=1 \
--output_dir_name="${model_dir_name}/isotonic_regression/testing_by_storm_type/storm-type=non_tropical/error_heat_map"
