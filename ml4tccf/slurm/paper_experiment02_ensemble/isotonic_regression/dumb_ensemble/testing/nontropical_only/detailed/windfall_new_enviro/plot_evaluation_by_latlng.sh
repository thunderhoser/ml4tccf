...
--input_evaluation_dir_name="${model_dir_name}/isotonic_regression/testing_by_storm_type/storm-type=non_tropical/testing_by_latlng" \
--latitude_spacing_deg=10 \
--longitude_spacing_deg=10 \
--main_font_size=40 \
--label_font_size=15 \
--output_dir_name="${model_dir_name}/isotonic_regression/testing_by_storm_type/storm-type=non_tropical/testing_by_latlng"
