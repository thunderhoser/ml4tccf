...
--input_prediction_file_pattern="${model_dir_name}/dumb_ensemble/isotonic_regression/testing_by_storm_type/storm-type=non_tropical/predictions*.nc" \
...
--output_file_name="${model_dir_name}/dumb_ensemble/isotonic_regression/testing_by_storm_type/storm-type=non_tropical/spread_vs_skill.nc"
