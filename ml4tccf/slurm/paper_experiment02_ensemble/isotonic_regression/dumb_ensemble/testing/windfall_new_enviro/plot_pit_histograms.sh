...
--input_file_name="${TOP_MODEL_DIR_NAME}/dumb_ensemble/isotonic_regression/testing/pit_histograms.nc" \
--ensemble_size_for_rank_hist=200 \
--output_dir_name="${TOP_MODEL_DIR_NAME}/dumb_ensemble/isotonic_regression/testing/pit_histograms"
