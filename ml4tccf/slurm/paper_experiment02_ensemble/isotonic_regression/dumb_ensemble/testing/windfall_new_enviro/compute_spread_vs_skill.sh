...
--input_prediction_file_pattern="${model_dir_name}/dumb_ensemble/isotonic_regression/testing/predictions*.nc" \
...
--output_file_name="${model_dir_name}/dumb_ensemble/isotonic_regression/testing/spread_vs_skill.nc"
