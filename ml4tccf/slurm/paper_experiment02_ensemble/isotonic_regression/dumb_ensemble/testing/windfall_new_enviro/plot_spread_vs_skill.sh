...
--input_file_name="${TOP_MODEL_DIR_NAME}/dumb_ensemble/isotonic_regression/testing/spread_vs_skill.nc" \
--output_dir_name="${TOP_MODEL_DIR_NAME}/dumb_ensemble/isotonic_regression/testing/spread_vs_skill"
