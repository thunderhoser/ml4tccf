...
--input_evaluation_file_name="${TOP_MODEL_DIR_NAME}/dumb_ensemble/isotonic_regression/testing/evaluation_no_bootstrap.nc" \
--confidence_level=0.95 \
--output_dir_name="${TOP_MODEL_DIR_NAME}/dumb_ensemble/isotonic_regression/testing/evaluation_no_bootstrap"
