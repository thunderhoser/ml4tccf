...
def write_file(
    ...
    dill.dump(x_coord_model_matrix, dill_file_handle)
    dill.dump(y_coord_model_matrix, dill_file_handle)
...
def read_file(dill_file_name):
    ...
    x_coord_model_matrix = dill.load(dill_file_handle)
    y_coord_model_matrix = dill.load(dill_file_handle)
