...
from ml4tccf.machine_learning import custom_losses_test

TOLERANCE = 1e-6

TARGET_MATRIX = custom_losses_test.TARGET_MATRIX
PREDICTION_MATRIX = custom_losses_test.PREDICTION_MATRIX
TARGET_TENSOR = custom_losses_test.TARGET_TENSOR
PREDICTION_TENSOR = custom_losses_test.PREDICTION_TENSOR
...
MEAN_DISTANCE_ERRORS_KM = numpy.sqrt(
    custom_losses_test.MEAN_ROW_DISTANCES_KM ** 2 +
    custom_losses_test.MEAN_COLUMN_DISTANCES_KM ** 2
)
MEAN_OVERALL_DISTANCE_KILOMETRES = numpy.mean(MEAN_DISTANCE_ERRORS_KM)

PREDICTION_DIFF_MATRIX_KM = numpy.sqrt(
    custom_losses_test.ROW_PREDICTION_DIFF_MATRIX_KM ** 2 +
    custom_losses_test.COLUMN_PREDICTION_DIFF_MATRIX_KM ** 2
)
...
class CustomMetricsTests(unittest.TestCase):
    ...
    def test_mean_prediction(self):
        ...
        this_mean_prediction = custom_metrics.mean_prediction(
    ...
    def test_mean_predictive_range(self):
        ...
        this_predictive_range = custom_metrics.mean_predictive_range(
            target_tensor=TARGET_TENSOR, prediction_tensor=PREDICTION_TENSOR
        )
        self.assertTrue(numpy.isclose(
    ...
    def test_mean_target(self):
        ...
        this_mean_target = custom_metrics.mean_target(
            target_tensor=TARGET_TENSOR, prediction_tensor=PREDICTION_TENSOR
        )
        self.assertTrue(numpy.isclose(
    ...
    def test_mean_grid_spacing_kilometres(self):
        ...
        this_mean_spacing_km = custom_metrics.mean_grid_spacing_kilometres(
            target_tensor=TARGET_TENSOR, prediction_tensor=PREDICTION_TENSOR
        )
        self.assertTrue(numpy.isclose(
    ...
    def test_mean_distance_kilometres(self):
        ...
        this_mean_distance_km = custom_metrics.mean_distance_kilometres(
            target_tensor=TARGET_TENSOR, prediction_tensor=PREDICTION_TENSOR
        )
        self.assertTrue(numpy.isclose(
    ...
    def test_crps_kilometres(self):
        ...
        this_crps_kilometres = custom_metrics.crps_kilometres(
            target_tensor=TARGET_TENSOR, prediction_tensor=PREDICTION_TENSOR
        )
        self.assertTrue(numpy.isclose(
