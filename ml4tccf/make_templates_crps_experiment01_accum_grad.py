"""Makes templates for first experiment with CRPS and accum gradients."""
...
OUTPUT_DIR_NAME = (
    ...
    'crps_experiment01_accum_grad/templates'
)
...
DENSE_LAYER_DROPOUT_RATES = numpy.array([0.2])
DENSE_LAYER_COUNTS = numpy.array([2], dtype=int)
CONV_LAYER_L2_WEIGHTS = numpy.array([1e-7])
CONV_LAYER_BY_BLOCK_COUNTS = numpy.array([1], dtype=int)
