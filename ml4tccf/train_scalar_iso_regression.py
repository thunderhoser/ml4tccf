"""Trains isotonic-regression models for scalar target variables (x and y)."""
...
import scalar_isotonic_regression as isotonic_regression
...
def _run(prediction_file_pattern, output_dir_name):
    ...
    if pt.attrs[prediction_utils.ISOTONIC_MODEL_FILE_KEY] is not None:
        raise ValueError(
