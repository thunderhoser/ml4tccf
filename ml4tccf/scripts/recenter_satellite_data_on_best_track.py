"""Recenters satellite data, using estimated TC centers from best-track."""
...
def _run(input_satellite_dir_name, best_track_dir_name, cyclone_id_string,
    ...
    for i in range(num_files):
        ...
        for j in range(num_times):
            ...
            if best_track_latitude_deg_n is None:
                continue
            ...
            latitude_diff_deg = numpy.absolute(
                best_track_latitude_deg_n - orig_latitude_deg_n
            )
            if latitude_diff_deg > 5:
                error_string = (
                    'Difference between original ({0:.4f} deg N) and best-'
            ...
            longitude_diff_deg = numpy.absolute(
                best_track_longitude_deg_e - orig_longitude_deg_e
            )
            if longitude_diff_deg > 7.5:
                error_string = (
                    'Difference between original ({0:.4f} deg E) and best-'
