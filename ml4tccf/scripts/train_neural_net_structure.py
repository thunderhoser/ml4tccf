...
from ml4tccf.scripts import training_args_structure as training_args
...
def _run(template_file_name, output_dir_name,
         ...
         target_field_names, target_file_name,
    ...
    training_option_dict = {
        nn_training.SATELLITE_DIRECTORY_KEY: satellite_dir_name_for_training,
        nn_training.YEARS_KEY: training_years,
        nn_training.LAG_TIMES_KEY: lag_times_minutes,
        nn_training.LOW_RES_WAVELENGTHS_KEY: low_res_wavelengths_microns,
        nn_training.BATCH_SIZE_KEY: num_examples_per_batch,
        nn_training.NUM_GRID_ROWS_KEY: num_rows_low_res,
        nn_training.NUM_GRID_COLUMNS_KEY: num_columns_low_res,
        nn_training.SENTINEL_VALUE_KEY: -10.,
        nn_training.SYNOPTIC_TIMES_ONLY_KEY: synoptic_times_only,
        nn_training.A_DECK_FILE_KEY: a_deck_file_name,
        nn_training.SCALAR_A_DECK_FIELDS_KEY: scalar_a_deck_field_names,
        nn_training.REMOVE_NONTROPICAL_KEY: remove_nontropical_systems,
...
if __name__ == '__main__':
    ...
    _run(
        ...
        remove_tropical_systems=bool(getattr(
            INPUT_ARG_OBJECT, training_args.REMOVE_TROPICAL_ARG_NAME
        )),
