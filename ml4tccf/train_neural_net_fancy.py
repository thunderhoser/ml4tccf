...
import neural_net_training_fancy as nn_training
import training_args_fancy as training_args
...
def _run(template_file_name, output_dir_name, lag_times_minutes,
         ...
         lag_time_tolerance_for_validation_sec,
         max_num_missing_lag_times_for_validation,
         max_interp_gap_for_validation_sec,
    ...
    :param lag_time_tolerance_for_validation_sec: Same.
    :param max_num_missing_lag_times_for_validation: Same.
    :param max_interp_gap_for_validation_sec: Same.
...
if __name__ == '__main__':
    ...
    _run(
        ...
        high_res_wavelengths_microns=numpy.array(
            getattr(
                INPUT_ARG_OBJECT, training_args.HIGH_RES_WAVELENGTHS_ARG_NAME
            ),
            dtype=float
        ),
        ...
        max_num_missing_lag_times_for_training=getattr(
            INPUT_ARG_OBJECT,
            training_args.MAX_MISSING_TIMES_FOR_TRAINING_ARG_NAME
        ),
        max_interp_gap_for_training_sec=getattr(
            INPUT_ARG_OBJECT, training_args.MAX_INTERP_GAP_FOR_TRAINING_ARG_NAME
        ),
        ...
        lag_time_tolerance_for_validation_sec=getattr(
            INPUT_ARG_OBJECT,
            training_args.TIME_TOLERANCE_FOR_VALIDATION_ARG_NAME
        ),
        max_num_missing_lag_times_for_validation=getattr(
            INPUT_ARG_OBJECT,
            training_args.MAX_MISSING_TIMES_FOR_VALIDATION_ARG_NAME
        ),
        max_interp_gap_for_validation_sec=getattr(
            INPUT_ARG_OBJECT,
            training_args.MAX_INTERP_GAP_FOR_VALIDATION_ARG_NAME
        ),
