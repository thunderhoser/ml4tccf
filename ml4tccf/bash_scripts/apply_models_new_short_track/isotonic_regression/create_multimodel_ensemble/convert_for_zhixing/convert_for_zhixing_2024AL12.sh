...
for valid_date_string in "${VALID_DATE_STRINGS[@]}"; do
    ...
    --input_prediction_file_name="${ENSEMBLE_DIR_NAME}/predictions_new_short_track/isotonic_regression/${CYCLONE_ID_STRING}_${valid_date_string}.nc" \
    ...
    --output_prediction_dir_name="${ENSEMBLE_DIR_NAME}/predictions_new_short_track/isotonic_regression/for_zhixing"
done
