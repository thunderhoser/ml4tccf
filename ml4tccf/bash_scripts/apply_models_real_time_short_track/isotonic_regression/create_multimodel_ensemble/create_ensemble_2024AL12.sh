...
for valid_date_string in "${VALID_DATE_STRINGS[@]}"; do
    ...
    --input_prediction_file_names "${MODEL_DIR_NAMES[0]}/real_time_predictions_short_track/isotonic_regression/${CYCLONE_ID_STRING}_${valid_date_string}.nc" "${MODEL_DIR_NAMES[1]}/real_time_predictions_short_track/isotonic_regression/${CYCLONE_ID_STRING}_${valid_date_string}.nc" "${MODEL_DIR_NAMES[2]}/real_time_predictions_short_track/isotonic_regression/${CYCLONE_ID_STRING}_${valid_date_string}.nc" "${MODEL_DIR_NAMES[3]}/real_time_predictions_short_track/isotonic_regression/${CYCLONE_ID_STRING}_${valid_date_string}.nc" \
    --max_total_ensemble_size=10000 \
    --output_prediction_file_name="${ENSEMBLE_DIR_NAME}/real_time_predictions_short_track/isotonic_regression/${CYCLONE_ID_STRING}_${valid_date_string}.nc"
done
