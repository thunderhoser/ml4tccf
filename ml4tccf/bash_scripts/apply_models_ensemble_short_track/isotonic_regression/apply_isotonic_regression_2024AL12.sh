...
for model_dir_name in "${MODEL_DIR_NAMES[@]}"; do
    ...
    for valid_date_string in "${VALID_DATE_STRINGS[@]}"; do
        ...
        --input_prediction_file_name="${model_dir_name}/ensemble_predictions_short_track/predictions_${CYCLONE_ID_STRING}_${valid_date_string}.nc" \
        --output_prediction_file_name="${model_dir_name}/ensemble_predictions_short_track/isotonic_regression/${CYCLONE_ID_STRING}_${valid_date_string}.nc"
    done
done
