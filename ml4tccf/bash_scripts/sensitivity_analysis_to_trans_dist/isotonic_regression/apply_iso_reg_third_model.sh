...
MODEL_DIR_NAMES=("/mnt/shnas10/users/lagerquist/ml4tccf_project/geocenter_models/wavelengths-microns=6.950-10.350-11.200")
...
for model_dir_name in "${MODEL_DIR_NAMES[@]}"; do
    ...
    for mean_translation_distance_px in "${MEAN_TRANSLATION_DISTANCES_PX[@]}"; do
        log_file_name="apply_iso_reg_third_model_mean-trans-dist-px=${mean_translation_distance_px}.out"
