...
OUTPUT_FILE_NAME="/mnt/shnas10/users/lagerquist/ml4tccf_project/geocenter_models/ensemble/real_time_predictions_short_track/isotonic_regression_gaussian_dist/uncertainty_calibration/homogeneous_comparison_with_archer2.nc"

log_file_name="waf2024_do_homogeneous_comp_with_archer.out"

python3 -u "${CODE_DIR_NAME}/waf2024_do_homogeneous_comp_with_archer.py" &> ${log_file_name} \
