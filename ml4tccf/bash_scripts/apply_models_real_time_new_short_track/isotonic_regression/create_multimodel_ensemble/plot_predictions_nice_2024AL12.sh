...
for valid_date_string in "${VALID_DATE_STRINGS[@]}"; do
    log_file_name="plot_predictions_nice_${CYCLONE_ID_STRING}_${valid_date_string}.out"
    ...
    --input_best_track_dir_name="/mnt/shnas10/users/galka/track_interpolated/best_track" \
