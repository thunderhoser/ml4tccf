...
for valid_date_string in "${VALID_DATE_STRINGS[@]}"; do
    log_file_name="convert_first_guess_for_zhixing_${CYCLONE_ID_STRING}_${valid_date_string}.out"
    ...
    --use_first_guess=1 \
    --output_prediction_dir_name="${ENSEMBLE_DIR_NAME}/real_time_predictions_new_short_track/isotonic_regression/for_zhixing/first_guess"
done
