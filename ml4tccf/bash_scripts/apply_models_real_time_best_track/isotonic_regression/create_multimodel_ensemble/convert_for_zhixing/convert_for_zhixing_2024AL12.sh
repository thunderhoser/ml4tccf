...
for valid_date_string in "${VALID_DATE_STRINGS[@]}"; do
    ...
    --input_prediction_file_name="${ENSEMBLE_DIR_NAME}/real_time_predictions_best_track/isotonic_regression/${CYCLONE_ID_STRING}_${valid_date_string}.nc" \
    --input_satellite_dir_name="/mnt/nvme-data5/lagerquist/ml4tccf_project/satellite_data/processed/normalized_params_for_paper/recentered_on_best_track/simplified_700x700" \
    --output_prediction_dir_name="${ENSEMBLE_DIR_NAME}/real_time_predictions_best_track/isotonic_regression/for_zhixing"
done
