...
log_file_name="plot_predictions_2024AL12_second.out"
...
--target_time_strings "2024-10-06-2300" "2024-10-06-2330" \
...
python3 -u "${CODE_DIR_NAME}/waf2024_plot_predictions.py" &> ${log_file_name} \
--input_prediction_file_name="${ENSEMBLE_DIR_NAME}/real_time_predictions_best_track/isotonic_regression/2024AL12_20241007.nc" \
--input_satellite_dir_name="${SATELLITE_DIR_NAME}" \
--input_normalization_file_name="${SATELLITE_NORM_FILE_NAME}" \
--target_time_strings "2024-10-07-0000" "2024-10-07-0030" "2024-10-07-0500" "2024-10-07-0530" "2024-10-07-0600" "2024-10-07-0630" "2024-10-07-0700" \
--num_samples_per_target_time=1 \
--lag_times_minutes 0 \
--wavelengths_microns 3.9  6.185  6.95  7.34  8.5  9.61  10.35  11.2  12.3  13.3 \
--prediction_plotting_format_string="probability_contours" \
...
--prob_contour_smoothing_radius_px=2 \
--prob_contour_opacity=0.7 \
--output_dir_name="${ENSEMBLE_DIR_NAME}/real_time_predictions_best_track/isotonic_regression/2024AL12_20241007"
