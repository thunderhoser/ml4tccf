"""Makes templates for Experiment 3 (regularization)."""
...
OUTPUT_DIR_NAME = (
    ...
    'experiment03_regularization/templates'
)
            ...
            for k in range(num_dropout_rates):
                for m in range(num_l2_weights):
                    ...
                    output_file_name = (
                        ...
                        'num-batches-per-update={2:02d}_'
                        'dense-layer-dropout-rate={3:.1f}_'
                        'conv-layer-l2-weight={4:.10f}'
                        '/model.h5'
                    ).format(
                        OUTPUT_DIR_NAME,
                        FIRST_LAYER_CHANNEL_COUNTS[i],
