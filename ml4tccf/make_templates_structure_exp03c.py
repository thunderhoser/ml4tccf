"""Makes CNN templates for Structure Experiment 3c.

Same as Experiment 3, except I have attempted to fix the problem with batch
normalization and gradient accumulation.  Specifically, I now call the
BatchNormalization layers with the argument `synchronized=True`.
"""
...
OUTPUT_DIR_NAME = (
    ...
    'structure_experiment03c/templates'
)
