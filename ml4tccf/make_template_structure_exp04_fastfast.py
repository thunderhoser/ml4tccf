"""Makes CNN template for Structure Experiment 4.

Same as Experiment 4, except without physical constraints in loss function.
"""
...
OUTPUT_DIR_NAME = (
    ...
    'structure_experiment04_fastfast/template'
)
...
def _run():
    """Makes CNN template for Structure Experiment 3.
