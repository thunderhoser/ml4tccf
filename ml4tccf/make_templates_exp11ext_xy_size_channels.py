"""Makes templates for Experiment 11, extended version."""
...
OUTPUT_DIR_NAME = (
    ...
    'experiment11ext_xy_size_channels/templates'
)
...
GRID_ROW_COUNTS_AXIS1_DUMMY = ['300-pool-by-3', '300', '400', '500', '590']
MAIN_POOLING_SIZES_PX_AXIS1 = numpy.array([3, 4, 4, 4, 4], dtype=int)
        ...
        for j in range(len(LAG_TIME_COUNTS_AXIS2)):
            for k in range(len(FIRST_LAYER_FILTER_COUNTS_AXIS3)):
                ...
                if GRID_ROW_COUNTS_AXIS1[i] == 300:
                    if MAIN_POOLING_SIZES_PX_AXIS1[i] == 3:
